                        ...
                        if (e.originalEvent && (e = e.originalEvent), C && y.emit("onTouchEnd", y, e), C = !1, T) {
                            ...
                            if (r = y.params.followFinger ? y.rtl ? y.translate : -y.translate : -P, y.params.freeMode) {
                                ...
                                if (y.params.freeModeMomentum) {
                                    ...
                                    H.length = 0;
                                    var p = 1e3 * y.params.freeModeMomentumRatio, d = y.velocity * p,
                                        u = y.translate + d;
                                    y.rtl && (u = -u);
...
(function ($) {
    ...
    !function (i, e, t, s) {
        t.swipebox = function (o, n) {
            var a = {useCSS: !0, hideBarsDelay: 3e3}, r = this, d = t(o), o = o, l = o.selector, p = t(l),
            ...
            r.settings = {}, r.init = function () {
                r.settings = t.extend({}, a, n), p.click(function (i) {
                    i.preventDefault(), i.stopPropagation(), index = d.index(t(this)), x.target = t(i.target), x.init(index)
                })
            };
            var x = {
                init: function (i) {
                    this.target.trigger("swipebox-start"), this.build(), this.openSlide(i), this.openImg(i), this.preloadImg(i + 1), this.preloadImg(i - 1)
                }, build: function () {
                    var e = this;
                    if (t("body").append(b), e.doCssTrans() && (t("#swipebox-slider").css({
                        ...
                        s = s.replace("png", "svg"), t("#swipebox-action #swipebox-prev,#swipebox-action #swipebox-next,#swipebox-action #swipebox-close").css({"background-image": s})
                    }
                    d.each(function () {
                        t("#swipebox-slider").append('<div class="slide"></div>')
                    }), e.setDim(), e.actions(), e.keyboard(), e.gesture(), e.animBars(), t(i).resize(function () {
                        e.setDim()
                    }).resize()
                }, setDim: function () {
                    var e = {width: t(i).width(), height: i.innerHeight ? i.innerHeight : t(i).height()};
                    ...
                    if (c) {
                        var i = this, e = null, s = 10, o = {}, n = {}, a = t("#swipebox-caption, #swipebox-action");
                        a.addClass("visible-bars"), i.setTimeout(), t("body").bind("touchstart", function (i) {
                            return t(this).addClass("touching"), n = i.originalEvent.targetTouches[0], o.pageX = i.originalEvent.targetTouches[0].pageX, t(".touching").bind("touchmove", function (i) {
                                i.preventDefault(), i.stopPropagation(), n = i.originalEvent.targetTouches[0]
                            }), !1
                        }).bind("touchend", function (r) {
                            r.preventDefault(), r.stopPropagation(), e = n.pageX - o.pageX, e >= s ? i.getPrev() : -s >= e ? i.getNext() : a.hasClass("visible-bars") ? (i.clearTimeout(), i.hideBars()) : (i.showBars(), i.setTimeout()), t(".touching").off("touchmove").removeClass("touching")
                        })
                    }
                }, setTimeout: function () {
                    if (r.settings.hideBarsDelay > 0) {
                        var e = this;
                        e.clearTimeout(), e.timeout = i.setTimeout(function () {
                            e.hideBars()
                    ...
                    this.doCssTrans() ? i.addClass("visible-bars") : (t("#swipebox-caption").animate({top: 0}, 500), t("#swipebox-action").animate({bottom: 0}, 500), setTimeout(function () {
                        i.addClass("visible-bars")
                    }, 1e3))
                }, hideBars: function () {
                    var i = t("#swipebox-caption, #swipebox-action");
                    this.doCssTrans() ? i.removeClass("visible-bars") : (t("#swipebox-caption").animate({top: "-50px"}, 500), t("#swipebox-action").animate({bottom: "-50px"}, 500), setTimeout(function () {
                        i.removeClass("visible-bars")
                    }, 1e3))
                }, animBars: function () {
                    var i = this, e = t("#swipebox-caption, #swipebox-action");
                    e.addClass("visible-bars"), i.setTimeout(), t("#swipebox-slider").click(function (t) {
                        e.hasClass("visible-bars") || (i.showBars(), i.setTimeout())
                    }), t("#swipebox-action").hover(function () {
                        i.showBars(), e.addClass("force-visible-bars"), i.clearTimeout()
                    }, function () {
                        e.removeClass("force-visible-bars"), i.setTimeout()
                    })
                }, keyboard: function () {
                    var e = this;
                    t(i).bind("keyup", function (i) {
                        i.preventDefault(), i.stopPropagation(), 37 == i.keyCode ? e.getPrev() : 39 == i.keyCode ? e.getNext() : 27 == i.keyCode && e.closeSlide()
                    })
                }, actions: function () {
                    var i = this;
                    d.length < 2 ? t("#swipebox-prev, #swipebox-next").hide() : (t("#swipebox-prev").bind("click touchend", function (e) {
                        e.preventDefault(), e.stopPropagation(), i.getPrev(), i.setTimeout()
                    }), t("#swipebox-next").bind("click touchend", function (e) {
                        e.preventDefault(), e.stopPropagation(), i.getNext(), i.setTimeout()
                    })), t("#swipebox-close").bind("click touchend", function (e) {
                        i.closeSlide(), $(".gallery-fix").delay(1).fadeOut(0)
                    })
                }, setSlide: function (i, e) {
                    e = e || !1;
                    var s = t("#swipebox-slider");
                    this.doCssTrans() ? s.css({left: 100 * -i + "%"}) : s.animate({left: 100 * -i + "%"}), t("#swipebox-slider .slide").removeClass("current"), t("#swipebox-slider .slide").eq(i).addClass("current"), this.setTitle(i), e && s.fadeIn(), t("#swipebox-prev, #swipebox-next").removeClass("disabled"), 0 == i ? t("#swipebox-prev").addClass("disabled") : i == d.length - 1 && t("#swipebox-next").addClass("disabled")
                }, openSlide: function (e) {
                    t("html").addClass("swipebox"), t(i).trigger("resize"), this.setSlide(e, !0)
                    ...
                    var e = this;
                    return 0 > i || i >= d.length ? !1 : void e.loadImg(d.eq(i).attr("href"), function () {
                        t("#swipebox-slider .slide").eq(i).html(this)
                    })
                }, setTitle: function (i, e) {
                    t("#swipebox-caption").empty(), d.eq(i).attr("title") && t("#swipebox-caption").append(d.eq(i).attr("title"))
                    ...
                    var i = this;
                    index = t("#swipebox-slider .slide").index(t("#swipebox-slider .slide.current")), index + 1 < d.length ? (index++, i.setSlide(index), i.preloadImg(index + 1)) : (t("#swipebox-slider").addClass("rightSpring"), setTimeout(function () {
                        t("#swipebox-slider").removeClass("rightSpring")
                    }, 500))
                }, getPrev: function () {
                    var i = this;
                    index = t("#swipebox-slider .slide").index(t("#swipebox-slider .slide.current")), index > 0 ? (index--, i.setSlide(index), i.preloadImg(index - 1)) : (t("#swipebox-slider").addClass("leftSpring"), setTimeout(function () {
                        t("#swipebox-slider").removeClass("leftSpring")
                    }, 500))
                }, closeSlide: function () {
                    var e = this;
                    t(i).trigger("resize"), t("html").removeClass("swipebox"), e.destroy()
                }, destroy: function () {
                    var e = this;
                    t(i).unbind("keyup"), t("body").unbind("touchstart"), t("body").unbind("touchmove"), t("body").unbind("touchend"), t("#swipebox-slider").unbind(), t("#swipebox-overlay").remove(), d.removeData("_swipebox"), e.target.trigger("swipebox-destroy")
                }
            };
            r.init()
    ...
    !function (a) {
        ...
        b.prototype.getSuffix = function (a, b) {
            ...
            var b, c, d, e, f, g = !0, h = 0,
                ...
                j = i / this.buildingRow.aspectRatio, k = this.buildingRow.width / i > this.settings.justifyThreshold;
        ...
        if (!t.fn.smoothState) {
            var r = t("html, body"), a = e.console, i = {
                ...
                isExternal: function (t) {
                    ...
                    n = " " + n || "";
                    var o = 0, r = "animationstart webkitAnimationStart oanimationstart MSAnimationStart",
                        a = "animationend webkitAnimationEnd oanimationend MSAnimationEnd", i = "allanimationend",
                        l = function (n) {
                ...
                if (null !== n.state) {
                    var o = e.location.href, r = t("#" + n.state.id), a = r.data("smoothState"),
                        i = a.href !== o && !s.isHash(o, a.href), l = n.state !== a.cache[a.href].state;
                    (i || l) && (l && a.clear(a.href), a.load(o, !1))
                }
            }, u = function (i, l) {
                var u = t(i), c = u.prop("id"), f = null, h = !1, d = {}, p = {}, g = e.location.href,
                    m = function (t) {
                ...
                return l = t.extend({}, t.fn.smoothState.options, l), null === e.history.state ? (p = l.alterChangeState({id: c}, n.title, g), e.history.replaceState(p, n.title, g)) : p = {}, s.storePageIn(d, g, n.documentElement.outerHTML, c, p), s.triggerAllAnimationEndEvent(u, "ss.onStartEnd ss.onProgressEnd ss.onEndEnd"), x(u), {
                    href: g,
                    cache: d,
                    clear: m,
                    load: w,
